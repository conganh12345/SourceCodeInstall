...
class AllPostController extends Controller
{
    ...
    public function store(AddpostRequest $request)
    {
        ...
        if ($result) {
            return to_route('all-post-management')->with('success', 'Tạo bài viết mới thành công');
        }

        return to_route('all-post-management')->with('error', 'Không thể tạo bài viết');
    }
    ...
    public function update(EditPostRequest $request, string $id)
    {
        ...
        return to_route('all-post-management')->with('success', 'Cập nhật bài viết thành công');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if ($result) {
            return to_route('all-post-management')->with('success', 'Xóa bài viết thành công');
        }

        return to_route('all-post-management')->with('error', 'Không thể xóa bài viết');
    }
    ...
    public function destroyAll()
    {
        ...
        return to_route('all-post-management')->with('success', 'Xóa tất cả bài viết thành công');
    }
